...
namespace Microsoft.Windows.Controls
{
    ...
    public class DataGridEndingEditEventArgs : EventArgs
    {
        ...
        public DataGridEndingEditEventArgs(DataGridColumn column, DataGridRow row, FrameworkElement editingElement, DataGridEditingUnit editingUnit)
        {
        ...
        private DataGridEditingUnit _editingUnit;
    }
}